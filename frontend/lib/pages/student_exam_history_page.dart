...
class StudentExamHistoryPage extends ConsumerWidget {
  const StudentExamHistoryPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: FutureBuilder<List<ExamHistoryModel>>(
        future: ref.read(examHistoryServiceProvider).getExamHistory(),
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => ExamHistoryDetailPage(history: item),
                      ),
                    );
                  },
                ),
