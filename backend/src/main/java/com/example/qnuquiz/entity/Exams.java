...
public class Exams implements java.io.Serializable {
    ...
    public Exams(long id, Users users, ExamCategories examCategories, String title, String description,
            String bannerUrl, Timestamp startTime, Timestamp endTime, boolean random, Integer maxQuestions,
            Integer durationMinutes, String status, Timestamp createdAt, Timestamp updatedAt,
