...
public class Users implements java.io.Serializable {
    ...
    public Users(UUID id, String username, String passwordHash, String fullName, String email,
            String phoneNumber, String avatarUrl, String role, String status, Timestamp createdAt, Timestamp updatedAt,
            Set<Questions> questionses, Set<Exams> examses, Set<Feedbacks> feedbacksesForUserId,
            Set<Students> studentses, Set<Announcements> announcementses, Set<Teachers> teacherses,
            Set<MediaFiles> mediaFileses, Set<Classes> classeses, Set<Feedbacks> feedbacksesForReviewedBy) {
        this.id = id;
        this.username = username;
        this.passwordHash = passwordHash;
