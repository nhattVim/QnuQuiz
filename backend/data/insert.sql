...
VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'admin1', '$2a$10$...hash_placeholder...', 'Quản trị viên', 'admin@qnu.edu.vn', 'ADMIN', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'teacher1', '$2a$10$...hash_placeholder...', 'Nguyễn Văn An (GV)', 'gv.an@qnu.edu.vn', 'TEACHER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', 'teacher2', '$2a$10$...hash_placeholder...', 'Trần Thị Bình (GV)', 'gv.binh@qnu.edu.vn', 'TEACHER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', 'teacher3', '$2a$10$...hash_placeholder...', 'Lê Văn Cường (GV)', 'gv.cuong@qnu.edu.vn', 'TEACHER', 'INACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'student1', '$2a$10$...hash_placeholder...', 'Phạm Thị Dung (SV)', 'sv.dung@qnu.edu.vn', 'STUDENT', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a16', 'student2', '$2a$10$...hash_placeholder...', 'Hoàng Văn Em (SV)', 'sv.em@qnu.edu.vn', 'STUDENT', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', 'student3', '$2a$10$...hash_placeholder...', 'Vũ Thị Hà (SV)', 'sv.ha@qnu.edu.vn', 'STUDENT', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- ========================
-- TABLE: question_categories (3 rows)
-- ========================
INSERT INTO question_categories (name, description, created_at)
VALUES
('Lập trình Java', 'Các câu hỏi về ngôn ngữ Java, OOP, Spring Boot', CURRENT_TIMESTAMP),
('Cơ sở dữ liệu', 'Các câu hỏi về SQL, NoSQL, thiết kế CSDL', CURRENT_TIMESTAMP),
('Mạng máy tính', 'Các câu hỏi về mô hình OSI, TCP/IP', CURRENT_TIMESTAMP);

-- ========================
-- TABLE: exams (3 rows)
-- [SỬA LỖI] Đã thêm cột `random`
-- ========================
INSERT INTO exams (title, description, created_by, start_time, end_time, duration_minutes, status, created_at, updated_at, random)
VALUES
('Thi cuối kỳ Java', 'Đề thi 60 phút, 40 câu', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', DATEADD('DAY', 1, NOW()), DATEADD('HOUR', 2, DATEADD('DAY', 1, NOW())), 60, 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
('Thi giữa kỳ CSDL', 'Đề thi 45 phút, 30 câu', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', DATEADD('DAY', 2, NOW()), DATEADD('HOUR', 2, DATEADD('DAY', 2, NOW())), 45, 'DRAFT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE),
('Kiểm tra 15p Mạng', '5 câu trắc nghiệm', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', DATEADD('DAY', 3, NOW()), DATEADD('HOUR', 2, DATEADD('DAY', 3, NOW())), 15, 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE);

-- ========================
-- TABLE: questions (3 rows)
-- ========================
INSERT INTO questions (exam_id, category_id, content, type, created_by, points, created_at, updated_at)
VALUES
(1, 1, 'Java là ngôn ngữ lập trình gì?', 'MULTIPLE_CHOICE', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 'Đa hình (Polymorphism) là một trong 4 tính chất của OOP. Đúng hay Sai?', 'TRUE_FALSE', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 'Câu lệnh nào dùng để truy vấn dữ liệu từ bảng?', 'MULTIPLE_CHOICE', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
(1, 1, DATEADD('HOUR', -1, NOW()), DATEADD('MINUTE', -30, NOW()), 5.0, TRUE, CURRENT_TIMESTAMP), -- SV 1 làm bài 1
(1, 2, DATEADD('HOUR', -1, NOW()), DATEADD('MINUTE', -25, NOW()), 10.0, TRUE, CURRENT_TIMESTAMP), -- SV 2 làm bài 1
(3, 1, DATEADD('HOUR', -2, NOW()), NULL, NULL, FALSE, CURRENT_TIMESTAMP); -- SV 1 đang làm bài 3
...
-- [SỬA LỖI] Đã thêm cột `published_at`
-- ========================
...
('hinh_minh_hoa_cau_1.jpg', 
'https://storage.googleapis.com/qnuquiz/questions/q1_img.jpg', 
'image/jpeg', 204800, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'questions', 1, CURRENT_TIMESTAMP),
('thong_bao_hoc_bong.pdf', 
'https://storage.googleapis.com/qnuquiz/announcements/hocbong.pdf', 
'application/pdf', 512000, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'announcements', 3, CURRENT_TIMESTAMP);
